...
export default function SintomasScreen() {
  ...
  return <AppBackground><StatusBar barStyle="dark-content" backgroundColor="transparent" translucent />
    <View style={styles.screen}>
      ...
      <View style={styles.bottomNav}><Nav icon="home-outline" label="Início" onPress={() => ir("Home")} /><Nav icon="calendar-month-outline" label="Ciclo" onPress={() => ir("Calendario")} /><Nav icon="meditation" label="Kegel" onPress={() => ir("Kegel")} /><Nav icon="dumbbell" label="Treinos" onPress={() => ir("TreinoDoDia")} /><Nav icon="account-outline" label="Perfil" onPress={() => ir("Perfil")} /></View>
    </View>
